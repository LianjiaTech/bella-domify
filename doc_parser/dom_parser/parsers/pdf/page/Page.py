...
In addition to base structure described in :py:class:`~dom_parser.page.RawPage`,
some new features, e.g. sections, table block, are also included. 
Page elements structure:

* :py:class:`~dom_parser.page.Page` >> :py:class:`~dom_parser.layout.Section` >> :py:class:`~dom_parser.layout.Column`
    * :py:class:`~dom_parser.layout.Blocks`
        * :py:class:`~dom_parser.text.TextBlock` >>
          :py:class:`~dom_parser.text.Line` >>
          :py:class:`~dom_parser.text.TextSpan` / :py:class:`~dom_parser.image.ImageSpan` >>
          :py:class:`~dom_parser.text.Char`
        * :py:class:`~dom_parser.table.TableBlock` >>
          :py:class:`~dom_parser.table.Row` >>
          :py:class:`~dom_parser.table.Cell`
            * :py:class:`~dom_parser.layout.Blocks`
            * :py:class:`~dom_parser.shape.Shapes`
    * :py:class:`~dom_parser.shape.Shapes`
        * :py:class:`~dom_parser.shape.Shape.Stroke`
        * :py:class:`~dom_parser.shape.Shape.Fill`
        * :py:class:`~dom_parser.shape.Shape.Hyperlink`
