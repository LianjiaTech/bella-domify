...
from doc_parser.dom_parser.parsers.pdf.common.Collection import Collection, ElementCollection
from doc_parser.dom_parser.parsers.pdf.common.share import RectType
